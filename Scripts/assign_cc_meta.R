...
## Metadata.csv can be downloaded from: https://microreact.org/project/uzDospiZeBSLfy4A8d1Uts-mega-alignment-phylogeny-and-minsnps-profiles
library(BiocParallel)
library(minSNPs)

all_seq_matrix <- read_fasta("mega_with_newdata.fasta")
megaalignment_meta <- read.csv("Metadata.csv")[,c(1:2)]
